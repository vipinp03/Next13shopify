          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                ...
                <div onClick={()=> setCollectionProductData([])}>  <h1 className=" font-bold cursor-pointer">All Product</h1></div>
              <h1 className="font-bold">Collection</h1>

                 {collectionData.length >0 && 
             collectionData.map((item)=>(
              <div onClick={()=>handelCollectionClick(item.node.title)}>
              <h1 className=" text-gray-500 cursor-pointer">{item.node.title}</h1>
              </div>
             ))
              }
              </div>
