...
function productDetail() {
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
       {/* LEFT SECTION   */}
      <div className="col-span-3 row-end-1">
        <div className="flex flex-col-reverse">
          <div className="order-2 ml-5">
            <div className="max-w-full overflow-hidden rounded-lg">
              <img className="h-full w-full max-w-full object-cover" src="https://cdn.shopify.com/s/files/1/0685/6808/8854/products/pdp_hair_4x_3e13f8cb-18ad-4268-a6c3-7a8c780b3a35_750x.jpg?v=1673613325" alt="" />
            </div>
          </div>

          <div className="mt-4 mx-5 w-full lg:order-1 lg:flex-shrink-0">
            <div className="flex flex-row items-start w-full">
              <button type="button" className="flex-0 aspect-square  m-1 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img className="h-full w-full object-cover" src="https://cdn.shopify.com/s/files/1/0685/6808/8854/products/pdp_hair_4x_3e13f8cb-18ad-4268-a6c3-7a8c780b3a35_750x.jpg?v=1673613325" alt="" />
              </button>
              <button type="button" className="flex-0 aspect-square m-1 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img className="h-full w-full object-cover" src="https://cdn.shopify.com/s/files/1/0685/6808/8854/products/pdp_hair_4x_3e13f8cb-18ad-4268-a6c3-7a8c780b3a35_750x.jpg?v=1673613325" alt="" />
              </button>
              <button type="button" className="flex-0 aspect-square m-1 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                <img className="h-full w-full object-cover" src="https://cdn.shopify.com/s/files/1/0685/6808/8854/products/pdp_hair_4x_3e13f8cb-18ad-4268-a6c3-7a8c780b3a35_750x.jpg?v=1673613325" alt="" />
      ...
      <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
        ...
        <button type="button" className=" w-full items-center justify-center rounded-md border-2 border-transparent bg-green-400 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow">
            Add to cart
          </button>
