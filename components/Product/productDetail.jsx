...
function productDetail({ handle }) {
  ...
  return (
    <section className="py-12 sm:py-16">
      {productDetail.hasOwnProperty('id') && (
        <div className="container mx-auto px-4">
          <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
              ...
              <div className="flex flex-col-reverse">
                ...
                <div className="mt-4 mx-5 w-full lg:order-1 lg:flex-shrink-0">
                  <div className="flex flex-row items-start w-full">
                    <button
                      type="button"
                      className="flex-0 aspect-square  m-1 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center"
                    >
                      <img
                    ...
                    <button
                      type="button"
                      className="flex-0 aspect-square m-1 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center"
                    >
                      <img
                        className="h-full w-full object-cover"
                        src={`${productDetail.images.edges[0].node.originalSrc}`}
            ...
            <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
              ...
              <h2 className="mt-8 text-base text-gray-900">Variants</h2>

              <div className="flex space-x-5">
                {/* {
              productDetail.variants.edges.map((item)=>(
              <>
              <div className="mt-3 flex select-none flex-wrap items-center gap-1">
                ...
                <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">{item}</p>
              </label>
            ...
            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
              ...
              {/* <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                <div className="flex items-end">
                  <h1 className="text-3xl font-bold">{productDetail.priceRange.maxVariantPrice.amount} {productDetail.priceRange.maxVariantPrice.currencyCode}</h1>
                </div>
              </div>
              <button
                type="button"
                className=" w-full items-center justify-center rounded-md border-2 border-transparent bg-green-400 bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow"
              >
                Add to cart
              </button> */}
